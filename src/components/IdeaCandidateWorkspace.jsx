...
const storageKey = 'dots:idea-candidates';
const conversationStorageKey = 'dots:idea-conversation';
const inputStorageKey = 'dots:idea-input-draft';
const legacyIdeaFormStorageKey = 'dots:idea-form-draft';
