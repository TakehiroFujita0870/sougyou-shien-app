...
export default { title: 'Dots./IdeaCandidateWorkspace', component: IdeaCandidateWorkspace, parameters: { layout: 'padded' } };
...
export const Conversation = { args: { repository: repository(), conversationRepository: conversationRepository([{ role: 'user', content: '工場の保全担当者が履歴を探せず困っています' }, { role: 'assistant', content: 'その困りごとを、どんな方法で解決する案ですか？' }]) } };
