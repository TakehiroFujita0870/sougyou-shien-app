...
export function HomeSupervisor({ repository, snapshot = initialSnapshot, onProjectAdopt, modelKey, models = [], onModelChange }) {
  ...
  return <section aria-labelledby="home-supervisor-heading" className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-[900px] flex-col">
    ...
    <form onSubmit={send} className="sticky bottom-0 mt-auto bg-[var(--color-background)] pb-1 pt-3">
