...
> 本書の5観点はピボット前の入力契約である。2026-09-20以降の事業評価レポートは[Dots Founder Graph ピボット・実装全体計画](founder-graph-pivot.md#事業評価レポート契約)の8章を出力契約とし、本書はDOCX / PDF adapter、未確定表示、privacy / attributionの既存設計として参照する。
...
| 2026-09-20 | 5観点を移植元とし、8章ReportVersionを新しい入力契約に指定 | Founder Graphピボットと指定章名を反映するため | T-FG-18、T-FG-26 |
