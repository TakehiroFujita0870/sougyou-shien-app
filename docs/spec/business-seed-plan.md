...
| ADR-60-04 機微データ | 銀行名、顧客ヒアリング、財務、画像prompt、個人制約は本人所有・明示選択・個別削除とし、横断knowledgeはknowledge単位で許可する | project間の既定共有と外部サービスへの自動送信は、同意と最小権限を満たさないため却下 | RLSと削除契約はresearch-memory-plan.mdへ従属 |
